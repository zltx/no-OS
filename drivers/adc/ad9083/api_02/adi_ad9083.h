...
typedef enum {
  ...
  AD9083_FULL_POWER_DOWN =
      2, /*!< Almost all of blocks are held in power down */
...
typedef enum {
  ...
  AD9083_ADC_PD_CLK_VTI =
      2, /*!< Power down pin disables adc clock and vti bias */
  AD9083_ADC_PD_CLK_VTI_MASTER_BIAS = 3, /*!< Power down pin disables adc clock,
                                            vti bias and adc masterbias block */
 ...
 */
typedef enum {
  AD9083_JESD_RX_PRBS_TEST_DATA_SRC_LANE =
      0x0, /*!< Lane Data As Test Data Source */
  AD9083_JESD_RX_PRBS_TEST_DATA_SRC_SAMPLE =
...
typedef enum {
  ...
  AD9083_JESD_TX_TEST_DATA_SCRAMBLER_INPUT =
...
typedef struct {
  ...
  adi_cms_signal_type_e
      syncoutb; /*!< Desired Signal type for SYNCOUTB signal */
  ...
  adi_tx_en_pin_ctrl_t tx_en_pin_ctrl; /*!< Function Pointer to HAL TX_ENABLE
                                          Pin Control function */
  adi_reset_pin_ctrl_t reset_pin_ctrl; /*!< Function Pointer to HAL RESETB Pin
                                          Control Function */
} adi_ad9083_hal_t;
 ...
 */
typedef struct {
  uint32_t dev_freq_hz; /*!< Device Clock Input frequency in KHz. Valid range
                           50MHz to 1GHz */
  uint32_t
      adc_freq_hz; /*!< ADC Clock Frequency in KHz. Valid range 1GHz to 2GHz */
} adi_ad9083_info_t;
 ...
 * @return <0                                   Failed. Check adi_cms_error_e
 * for details.
 */
...
/**
 * @brief  Initialize ad9083 device
 *
 * @param  device             Pointer to the device structure
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 ...
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 */
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  addr               SPI address to which the value of data parameter
 * shall be written
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  addr               SPI address from which the value of data parameter
 * shall be read,
 * @param  data               Pointer to an 8-bit variable to which the value of
 * the SPI register at the address defined by address parameter shall be stored.
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  operation          A parameter to indicate reset operation. @see
 * adi_ad9083_reset_e AD9083_SOFT_RESET indicates a software reset is required.
 *                            AD9083_HARD_RESET indicates a hardware reset is
 * required. AD9083_SOFT_RESET_AND_INIT indicates a software reset +
 * initialization is required. AD9083_HARD_RESET_AND_INIT indicates a hardware
 * reset + initialization is required.
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 ...
 *                            which the product data read-back from chip shall
 * be stored.
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 ...
 * details.
 */
int32_t adi_ad9083_device_laminate_id_get(adi_ad9083_device_t *device,
                                          uint8_t *id);
 ...
 * @param  ref_clk_hz         Reference clock frequency, if ref_clk_hz >=
 * AD9083_REF_CLK_FREQ_HZ_MAX, bypass PLL
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  status             Pointer to pll lock fast (bit1) and slow status
 * (bit0)
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 ...
 * @param  zero_stuffing_en   enable/disable zero_stuffing_en
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  adc_clk_hz         Pointer to variable to store the current clk
 * frequency in Hz
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  i_resolution       0 - 16-bit, 1 - 15-bit, 2 - 14-bit, 3 - 13-bit, 4
 * - 12-bit
 * @param  q_resolution       0 - 16-bit, 1 - 15-bit, 2 - 14-bit, 3 - 13-bit, 4
 * - 12-bit
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 ...
 *
 * @param  device             Pointer to the device structure
 * @param  jesd_param         JESD parameter pointer
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
 */
int32_t adi_ad9083_jesd_startup(adi_ad9083_device_t *device,
...
/**
 * @brief  Configure the JESD Tx lane cross bar between physical lane and
 * logical lane
 *
 * @param  device             Pointer to the device structure
 ...
 * @param prbs_pattern        PRBS pattern identifier, @see
 * adi_cms_jesd_prbs_pattern_e PRBS7, PRBS15, PRBS31
 *
 * @return API_CMS_ERROR_OK                     API Completed Successfully
 * @return <0                                   Failed. @see adi_cms_error_e for
 * details.
