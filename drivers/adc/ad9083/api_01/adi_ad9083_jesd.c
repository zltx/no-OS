...
int32_t adi_ad9083_jesd_startup(adi_ad9083_device_t *device,
  ...
  err = adi_ad9083_jesd_tx_link_config_set(device, jesd_param);
  AD9083_ERROR_RETURN(err);
  ...
  AD9083_ERROR_RETURN(err);
  err = adi_ad9083_jesd_tx_lanes_enable_set(device, jesd_param->jesd_l);
  AD9083_ERROR_RETURN(err);
  ...
  /* enable jtx phys */
  err = adi_ad9083_jesd_tx_phy_enable_set(device, jesd_param->jesd_l);
  AD9083_ERROR_RETURN(err);
