...
#define AD9083_FIXED_QMUL(x, y, xFb, yFb, resFb) ((uint32_t)(((uint64_t)(x) * (uint64_t)(y))>>((xFb) + (yFb)- (resFb))))
#define AD9083_FIXED_QDIV(x, y, xFb, yFb, resFb) ((uint32_t)((((uint64_t)(x)) << ((resFb) + (yFb) - (xFb))) / (y)))

int32_t adi_ad9083_rx_cic_dec_rate_set(adi_ad9083_device_t *device, adi_ad9083_cic_dec_rate_e dec_rate)
{
    int32_t err;
...
int32_t adi_ad9083_rx_cic_acc_clear_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_bypass_cic_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_j_dec_rate_set(adi_ad9083_device_t *device, adi_ad9083_j_dec_rate_e dec_j)
{
    int32_t err;
    /* Bypassing CIC decimation */
    uint8_t valid_j_dec_1[7]  = {AD9083_J_DEC_8,  AD9083_J_DEC_12, AD9083_J_DEC_16, AD9083_J_DEC_20,
                                 AD9083_J_DEC_24, AD9083_J_DEC_40, AD9083_J_DEC_60};
    /* Using CIC deciamtion, bypassing mixer */
    uint8_t valid_j_dec_2[10] = {AD9083_J_DEC_1,  AD9083_J_DEC_4,  AD9083_J_DEC_8,  AD9083_J_DEC_10,
    ...
    uint8_t valid_j_dec_3[4]  = {AD9083_J_DEC_1,  AD9083_J_DEC_4, AD9083_J_DEC_8, AD9083_J_DEC_16};
...
int32_t adi_ad9083_rx_nco_phase_offset_set (adi_ad9083_device_t *device, uint8_t index, uint8_t phase_offset)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_nco_adither_enable_set (adi_ad9083_device_t *device, uint8_t index, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_nco_6db_gain_enable_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_bypass_mixer_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_num_tones_set(adi_ad9083_device_t *device, uint8_t num_tones)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_zero_stuff_enable_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_clk_sample_order_sel(adi_ad9083_device_t *device, uint8_t sel)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_clk_sample_polarity_set(adi_ad9083_device_t *device, uint8_t pol)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_test_mode_sel_set(adi_ad9083_device_t *device, uint8_t tmode_sel[12])
{
    int32_t i;
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_res_set(adi_ad9083_device_t *device, uint8_t res)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_dformat_fbw_dither_enable_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_dformat_ddc_dither_enable_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_dformat_cic_sel_set(adi_ad9083_device_t *device, uint8_t sel[12])
{
    uint8_t i;
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_cic_sel_all_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    uint8_t i, sel[12];
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_fbw_sel_set(adi_ad9083_device_t *device, uint8_t sel[12])
{
    uint8_t i;
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_fbw_sel_all_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    uint8_t i, sel[12];
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_average_sel_set(adi_ad9083_device_t *device, uint8_t sel[12])
{
    uint8_t i;
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_average_sel_all_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    uint8_t i, sel[12];
    AD9083_NULL_POINTER_RETURN(device);
...
int32_t adi_ad9083_rx_dformat_cic_div_sel_set(adi_ad9083_device_t *device, uint8_t sel)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_dformat_fbw_div_sel_set(adi_ad9083_device_t *device, uint8_t sel)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_dformat_out_div_sel_set(adi_ad9083_device_t *device, uint8_t sel)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_adc_enable_set(adi_ad9083_device_t *device, uint16_t adcs)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_adc_pd_pin_mode_set(adi_ad9083_device_t *device, adi_ad9083_adc_pd_pin_mode_e mode)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_adc_reset_enable_set(adi_ad9083_device_t *device, uint8_t enable)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_adc_term_res_set(adi_ad9083_device_t *device, adi_ad9083_adc_term_res_e res)
{
    int32_t err;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
...
int32_t adi_ad9083_rx_adc_kvti_factor_fixed_get(adi_ad9083_device_t *device, uint32_t orc1mode, uint32_t backoff, uint64_t finmax, uint32_t *kvti_factor)
{
    ...
    /* kvti_factor=44 * min(max(min(10**(-backoff/20), max(orc1mode, (clkfreq/2e3)*(100e6/finmax))), 0.333),1) */
    adc_clk_hz = device->dev_info.adc_freq_hz;
    ...
    factor = AD9083_FIXED_QMUL(factor, 44, 30, 0, 26);     /* kvti_factor: 14.52 ~ 44  QQ26 */

    *kvti_factor = factor;
    return API_CMS_ERROR_OK;
}

int32_t adi_ad9083_rx_adc_fscale_fixed_get(adi_ad9083_device_t *device, uint8_t bcenter_os, uint32_t *fscale)
{
    uint32_t adc_clk_hz;
...
int32_t adi_ad9083_rx_adc_vti_set(adi_ad9083_device_t *device, uint32_t fc, uint32_t vmax, uint8_t en_hp, uint32_t orc1mode, uint32_t backoff, uint64_t finmax, uint32_t *kgain, uint8_t *bcenter_os)
{
    int32_t err;
    ...
    err = adi_ad9083_rx_adc_kvti_factor_fixed_get(device, orc1mode, backoff, finmax, &kvti_factor);
    AD9083_ERROR_RETURN(err);
    ...
    kvti_fixed = AD9083_FIXED_QMUL(fscale, kvti_factor, 30, 26, 26);  /* Q26  max is 38.28 */
    qresult = AD9083_FIXED_QDIV((1 + en_hp) * 1000, vmax, 0, 0, 29);  /* Q29  max is 4     */
    kvti_fixed = AD9083_FIXED_QMUL(kvti_fixed, qresult, 26, 29, 24);  /* max is 153.12     */
...
int32_t adi_ad9083_rx_adc_config_set(adi_ad9083_device_t *device, uint32_t vmax, uint32_t fc, uint8_t rterm, uint8_t en_hp, uint32_t backoff, uint64_t finmax)
{
    ...
    /* cal cap and gain */
    err = adi_ad9083_rx_adc_vti_set(device, fc, vmax, en_hp, orc1mode, backoff, finmax, &kgain, &bcenter_os);
    AD9083_ERROR_RETURN(err);
    ...
    AD9083_ERROR_RETURN(err);
    err = adi_ad9083_hal_reg_set(device, REG_DITHER_DAC_CURRENT1_REG_ADDR, gdith1);
    AD9083_ERROR_RETURN(err);
    err = adi_ad9083_hal_reg_set(device, REG_DITHER_DAC_CURRENT2_REG_ADDR, gdith2);
    AD9083_ERROR_RETURN(err);
    ...
    AD9083_ERROR_RETURN(err);
    err = adi_ad9083_hal_reg_set(device, REG_VTI_SHIFT_CURRENT_MSB_REG_ADDR, 0x20);
    AD9083_ERROR_RETURN(err);
...
int32_t adi_ad9083_rx_get_num_tones(adi_ad9083_device_t *device, uint64_t nco_freq_hz[3], uint8_t *tone_nums)
{
    uint8_t num = 0;
    AD9083_NULL_POINTER_RETURN(device);
    AD9083_LOG_FUNC();
    ...
    *tone_nums = num;
    ...
    if (((nco_freq_hz[0] == 0) && ((nco_freq_hz[1] > 0) || (nco_freq_hz[2] > 0))) || ((nco_freq_hz[1] == 0) && (nco_freq_hz[2] > 0)))
    {
        return API_CMS_ERROR_INVALID_PARAM;
    }
...
int32_t adi_ad9083_rx_datapath_config_set(adi_ad9083_device_t *device, adi_ad9083_datapath_mode_e mode, uint8_t dec[4], uint64_t nco_freq_hz[3])
{
    ...
    uint8_t sample_order, deci_adc_data, no_ddc_mode, burst_mode, zstuff_en, num_tones, nco_6db_gain;
    ...
    if ((mode != AD9083_DATAPATH_ADC_CIC_NCO_G_H) && ((mode != AD9083_DATAPATH_ADC_CIC_NCO_G))) {
        if (non_zero_tones > 1) {
            err = adi_ad9083_hal_log_write(device, ADI_CMS_LOG_WARN, "datapath mode not match non-zero NCO shift values.");
            AD9083_ERROR_RETURN(err);
        }
    }
